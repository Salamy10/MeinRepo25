...
public class E01_ConsoleApplications03 {
   ...
   public static void main(String[] args) {
      ...
      System.out.print("Spieler 1, KÃ¤mpfer 1, Name: ");
      nameOfFighter1 = scanner.next();
      System.out.print("Spieler 1, KÃ¤mpfer, LP: ");
      healthPointsOfFighter1 = scanner.nextInt();

      System.out.print("Spieler 2, Name: ");
      nameOfPlayer2 = scanner.next();
      System.out.print("Spieler 2, KÃ¤mpfer 2, Name: ");
      nameOfFighter2 = scanner.next();
      System.out.print("Spieler 2, KÃ¤mpfer, LP: ");
      ...
      System.out.println("KÃ¤mpfer von " + nameOfPlayer1 + ": " + nameOfFighter1 + " ("
            + healthPointsOfFighter1 + " LP)");
      System.out.println("KÃ¤mpfer von " + nameOfPlayer2 + ": " + nameOfFighter2 + " ("
      ...
      System.out.println(nameOfFighter1 + " wÃ¼rfelt " + valueOfDice1 + ", " + valueOfDice2 + ", "
            + valueOfDice3 + " und " + valueOfDice4 + ".");
      System.out.println(nameOfFighter1 + " erzielt " + totalHits + " Treffer.");
      System.out.println(nameOfFighter2 + " wÃ¼rfelt " + valueOfDice5 + ", " + valueOfDice6 + " und "
            + valueOfDice7 + ".");
      ...
      System.out.println(nameOfFighter2 + " wÃ¼rfelt " + valueOfDice1 + ", " + valueOfDice2 + ", "
            + valueOfDice3 + " und " + valueOfDice4 + ".");
      System.out.println(nameOfFighter2 + " erzielt " + totalHits + " Treffer.");
      System.out.println(nameOfFighter1 + " wÃ¼rfelt " + valueOfDice5 + ", " + valueOfDice6 + " und "
            + valueOfDice7 + ".");
